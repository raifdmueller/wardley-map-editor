    ...
    <main class="col-12 col-md-12 col-xl-12 pl-md-12" role="main">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8">
                    ...
                    <div class="d-flex gap-3">
                        <a href="arc42.html" class="btn btn-light btn-lg">📋 View Architecture</a>
        ...
        <div class="bg-light p-4 rounded mb-5">
            ...
            <div class="text-center">
                <a href="arc42.html#_9_architekturentscheidungen" class="btn btn-outline-primary">
        ...
        <div class="text-center py-5">
            ...
            <div class="d-flex justify-content-center gap-3 flex-wrap">
                <a href="arc42.html" class="btn btn-primary btn-lg">
